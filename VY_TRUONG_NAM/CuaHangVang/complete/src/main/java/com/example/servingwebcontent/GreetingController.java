...
public class GreetingController {
    ...
    @GetMapping("/customer")
    public String customer(@RequestParam(name = "name", required = false, defaultValue = "Khách lạ") String name,
    ...
    @GetMapping("/product")
    public String product(@RequestParam(name = "name", required = false, defaultValue = "Nhẫn vàng") String name,
    ...
    public String transaction(@RequestParam(name = "customer", required = false, defaultValue = "Khách A") String customerName,
                              @RequestParam(name = "phone", required = false, defaultValue = "Không rõ") String phone,
